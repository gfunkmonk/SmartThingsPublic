/**
 *  GE Dimmer Switch (Model 14294) DTH
 *
 *  Copyright © 2018 Andrew Sayre
 *  Original Author: SmartThings
 *
 *  Version 1.0.0 (11/04/2018) - Original release with dimming transition support
 *
 ...
 *   Double-Tap Down   2        down_2x
 *
 */
metadata {
	definition (name: "GE Dimmer Switch 14294", namespace: "andrewsayre", author: "Andrew Sayre", ocfDeviceType: "oic.d.light", runLocally: false, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		...
		fingerprint mfr:"0063", prod:"4944", model:"3038", ver: "5.26", deviceJoinName: "GE In-Wall Smart Dimmer"
        fingerprint mfr:"0063", prod:"4944", model:"3038", ver: "5.29", deviceJoinName: "GE In-Wall Smart Dimmer"
	}
...
def updated(){  
    ...
    sendEvent(name: "supportedButtonValues", value: ["down_2x", "up_2x"], displayed: false)
    ...
    sendHubCommand(cmds.collect{ new physicalgraph.device.HubAction(it.format()) }, 100)
}

def getCommandClassVersions() {
	// Supported command classes: https://products.z-wavealliance.org/products/2105/classes
    // Mapping to SmartThings: https://graph.api.smartthings.com/ide/doc/zwave-utils.html
	[
		0x20: 1,  // Basic					https://graph.api.smartthings.com/ide/doc/zwave-utils.html#basicV1
		0x26: 2,  // Switch Multilevel		https://graph.api.smartthings.com/ide/doc/zwave-utils.html#switchMultilevelV2
		0x56: 1,  // Crc16Encap				https://graph.api.smartthings.com/ide/doc/zwave-utils.html#crc16EncapV1
		0x70: 1,  // Configuration			https://graph.api.smartthings.com/ide/doc/zwave-utils.html#configurationV1
    //  0x72: 2,  // Manufacturer Specific	https://graph.api.smartthings.com/ide/doc/zwave-utils.html#manufacturerSpecificV2
    //	0x85: 2,  // Association			https://graph.api.smartthings.com/ide/doc/zwave-utils.html#associationV2
	]
}
...
def zwaveEvent(physicalgraph.zwave.commands.switchmultilevelv2.SwitchMultilevelStopLevelChange cmd) {
	[createEvent(name:"switch", value:"on"), response(zwave.switchMultilevelV2.switchMultilevelGet().format())]
}
...
def setLevel(value) {
	setLevel(value, defaultFadeDuration)
}

def setLevelV1(value) {
	...
	delayBetween ([zwave.basicV1.basicSet(value: level).format(), zwave.switchMultilevelV2.switchMultilevelGet().format()], 5000)
}
